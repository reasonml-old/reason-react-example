  ...
  newrecord[/* render */9] = (function (param) {
      ...
      var todoItems = List.map((function (todo) {
              ...
              return ReasonReact.element(/* Some */[todo[/* id */0]], /* None */0, TodoItem.make(todo, editing$1, (function () {
                                return Curry._1(send, /* Destroy */Block.__(3, [todo]));
                              }), (function (text) {
                                return Curry._1(send, /* Save */Block.__(1, [
                                              todo,
                                              text
                                            ]));
                              }), (function () {
                                return Curry._1(send, /* Edit */Block.__(2, [todo]));
                              }), (function () {
                                return Curry._1(send, /* Toggle */Block.__(4, [todo]));
                              }), (function () {
                                return Curry._1(send, /* Cancel */6);
                              }), /* array */[]));
      ...
      if (exit === 1) {
        footer = ReasonReact.element(/* None */0, /* None */0, TodoFooter.make(activeTodoCount, completedCount, state[/* nowShowing */0], (function () {
                    return Curry._1(send, /* ClearCompleted */5);
                  }), /* array */[]));
      }
      ...
      var main = match !== 0 ? null : React.createElement("section", {
              className: "main"
                  ...
                  onChange: (function ($$event) {
                      ...
                      return Curry._1(send, /* ToggleAll */Block.__(5, [checked]));
                    })
                      ...
                      className: "header"
                          ...
                          onKeyDown: (function ($$event) {
                              if ($$event.keyCode === 13) {
                                ...
                                return Curry._1(send, /* NewTodoEnterKeyDown */3);
                              } else {
                                return Curry._1(send, /* NewTodoOtherKeyDown */4);
                              }
                            }),
                          onChange: (function ($$event) {
              ...
              /* Sub */[
                (function () {
                    return ReasonReact.Router[/* watchUrl */1]((function (url) {
                                  ...
                                  switch (match) {
                                    case "active" : 
                                        return Curry._1(self[/* send */4], /* ShowActive */1);
                                    case "completed" : 
                                        return Curry._1(self[/* send */4], /* ShowCompleted */2);
                                    default:
                                      return Curry._1(self[/* send */4], /* ShowAll */0);
                                  }
                                }));
                  }),
