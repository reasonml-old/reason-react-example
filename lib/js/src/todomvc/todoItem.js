...
function handleEdit(param, _) {
  ...
  return /* Some */[/* record */[
            /* editText */props[/* todo */0][/* title */1],
            /* editFieldRef */param[/* state */0][/* editFieldRef */1]
          ]];
}
...
function handleKeyDown(componentBag, $$event) {
  ...
  if ($$event.which === 27) {
    ...
    return /* Some */[/* record */[
              /* editText */props[/* todo */0][/* title */1],
              /* editFieldRef */componentBag[/* state */0][/* editFieldRef */1]
            ]];
...
function setEditFieldRef(param, r) {
  param[/* state */0][/* editFieldRef */1] = r === null ? /* None */0 : [r];
  return /* () */0;
}
...
function componentDidUpdate(prevProps, _, param) {
  ...
  var match$2 = param[/* state */0][/* editFieldRef */1];
  if (match !== 0) {
    return /* None */0;
  } else if (match$1 !== 0) {
    if (match$2) {
...
var TodoItem_006 = /* JsProps */include[7];

var TodoItem_007 = /* InstanceVars */include[8];
