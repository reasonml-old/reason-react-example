...
var component = ReasonReact.createComponent("TodoItemRe");
...
function make(todo, editing, onDestroy, onSave, onEdit, onToggle, onCancel, _) {
  ...
  newrecord[/* propsReceived */3] = function (state, _) {
    return /* record */[
            /* editText */state[/* editText */0],
            /* editFieldRef */state[/* editFieldRef */1],
            /* editing */editing
  ...
  newrecord[/* didUpdate */5] = function (previous, current, _) {
    var match = previous[/* editing */2];
    var match$1 = current[/* editFieldRef */1];
    if (match !== 0) {
      return /* () */0;
    } else if (editing !== 0) {
      if (match$1) {
