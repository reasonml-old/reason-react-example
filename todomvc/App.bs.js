...
var TodoItem$ReactLite = require("./TodoItem.bs.js");
var TodoFooter$ReactLite = require("./TodoFooter.bs.js");
  ...
  return /* record */[
          ...
          /* render */(function (param) {
              ...
              var todoItems = Belt_List.map(__x, (function (todo) {
                      ...
                      return ReasonReact.element(todo[/* id */0], undefined, TodoItem$ReactLite.make(todo, editing$1, (function (_event) {
              ...
              if (exit === 1) {
                footer = ReasonReact.element(undefined, undefined, TodoFooter$ReactLite.make(activeTodoCount, completedCount, state[/* nowShowing */0], (function (_event) {
          ...
          /* initialState */(function (param) {
              ...
              return /* record */[
                      /* nowShowing */urlToShownPage(ReasonReactRouter.dangerouslyGetInitialUrl(/* () */0)[/* hash */1]),
                      /* editing */undefined,
                      /* newTodo */"",
                      /* todos */todos
                    ];
